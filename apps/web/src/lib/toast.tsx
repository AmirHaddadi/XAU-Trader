      ...
      <div className="pointer-events-none fixed bottom-4 right-4 z-50 flex w-full max-w-sm flex-col gap-2">
        {items.map((t) => (
          <div
            ...
            className="animate-fade-in-up pointer-events-auto cursor-pointer rounded-lg border bg-card px-3 py-2 text-sm text-text-primary shadow-lg backdrop-blur-sm"
