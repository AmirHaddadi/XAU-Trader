...
const EN = {
  ...
  crosshair: "Crosshair",
  crosshairHint: "Show/hide the chart's crosshair guide lines",
  symbolSwitchHint: "Switch symbol — XAUUSD, or BTCUSD/ETHUSD for weekend testing when gold markets are closed",
...
const FA: Record<keyof typeof EN, string> = {
  ...
  crosshair: "کراس‌هیر",
  crosshairHint: "نمایش/عدم‌نمایش خطوط راهنمای کراس‌هیر روی چارت",
  symbolSwitchHint: "تعویض نماد — طلا، یا بیت‌کوین/اتریوم برای تست در روزهای تعطیل بازار",
  toolSelector: "سلکتور",
